package com.rick.financial_pay.service;
...
import com.rick.financial_pay.util.HttpUtil;
import com.rick.financial_pay.util.Pkipair;
...
public class KuiQianService {
    ...
    public boolean addRecharge(Integer uid, BigDecimal rechargeMoney, String orderId) {
        ...
        record.setRechargeStatus(LoanConstant.RECHARGE_STATUS_PROCESSING);
    ...
    private String generateOrderId(){
        ...
        String key = RedisKeyConstant.KEY_RECHARGE_ORDERID;
    ...
    public void addOrderIdToRedis(String orderId) {
        String key  = RedisKeyConstant.KEY_ORDERID_SET;
    ...
    public void kqNotify(HttpServletRequest request) {
        ...
        //删除redis中的订单记录
        stringRedisTemplate.boundZSetOps(RedisKeyConstant.KEY_ORDERID_SET).remove(orderId);
    }
    ...
    public void handleQueryOrder() {
        ...
        Set<String> orders = stringRedisTemplate
                    .boundZSetOps(RedisKeyConstant.KEY_ORDERID_SET).range(0, -1);
